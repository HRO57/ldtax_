...
@section('title', 'ভূমি সংক্রান্ত পরিপত্র/প্রজ্ঞাপন সম্পাদনা করুন')
@section('content-header', 'ভূমি সংক্রান্ত পরিপত্র/প্রজ্ঞাপন সম্পাদনা করুন')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('poripotro_proggapons.update', $data) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="poripotro_proggapon_doc"
                        class="form-control-file @error('poripotro_proggapon_doc') is-invalid @enderror"
                        id="poripotro_proggapon_doc">
                ...
                <a href="{{ route('poripotro_proggapons.index') }}" class="btn btn-danger">বাতিল করুন</a>
