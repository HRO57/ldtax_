...
@section('title', 'অ্যাপ এবং সফটওয়্যার তৈরি করুন')
@section('content-header', 'অ্যাপ এবং সফটওয়্যার তৈরি করুন')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('apps-and-softwares.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="type" class="form-control @error('type') is-invalid @enderror" id="type">
                        <option value="1">জমি কেন্দ্রিক তথ্য</option>
                        <option value="2">জমির সফটওয়্যার</option>
                    </select>
                    @error('type')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
