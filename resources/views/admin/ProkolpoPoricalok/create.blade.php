...
@section('title', 'প্রকল্প পরিচালক তৈরি করুন')
@section('content-header', 'প্রকল্প পরিচালক তৈরি করুন')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('prokolpo_poricaloks.store') }}" method="POST" enctype="multipart/form-data">
