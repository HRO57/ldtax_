...
@section('title', 'নীতিমালা ও শর্তাবলী তালিকা')
@section('content-header', 'নীতিমালা ও শর্তাবলী তালিকা')
@section('content-actions')
    <a href="{{ route('nitimalas.create') }}" class="btn btn-success">তৈরি করুন</a>
@endsection
@section('css')
    ...
    <div class="card slider-list">
        <div class="card-body table-responsive p-0"> <!-- Wrap table in a responsive container -->
            <table class="table">
                <thead>
                    <tr class="">
                        <th>নীতিমালা ও শর্তাবলী বিবরণ</th>
                        <th>স্ট্যাটাস</th>
                    ...
                    @forelse ($data as $item)
                        <tr>
                            ...
                            <td class="text-truncate" style="max-width: 200px;">
                                {{ strip_tags(str_replace('&nbsp;', ' ', $item->nitimala_description)) }}</td>
                            ...
                            <td class="text-center d-flex justify-content-center align-items-center">
                                ...
                                <a href="{{ route('nitimalas.edit', $item) }}" class="btn btn-primary btn-sm ml-2"><i
                                        class="fas fa-edit"></i></a>
                                <button class="btn btn-danger btn-sm btn-delete ml-1"
                                    data-url="{{ route('nitimalas.destroy', $item) }}"><i class="fas fa-trash"></i></button>
                            </td>
