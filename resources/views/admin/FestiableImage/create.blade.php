...
@section('title', 'উৎসব-চিত্র তৈরি করুন')
@section('content-header', 'উৎসব-চিত্র তৈরি করুন')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('festivals-images.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-5">
                    {{-- {{ $disableCreateButton ? 'disabled' : '' }}  Disable for limitation --}}
                    <a href="{{ route('festivals-images.index') }}" class="btn btn-danger">বাতিল করুন</a>
