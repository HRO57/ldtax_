...
@section('title', 'প্রকল্প সারসংক্ষেপ তালিকা')
@section('content-header', 'প্রকল্প সারসংক্ষেপ তালিকা')
@section('content-actions')
    <a href="{{ route('prokolpo_sarsongkheps.create') }}" class="btn btn-success">তৈরি করুন</a>
@endsection
@section('css')
            ...
            <table class="table">
                <thead>
                    <tr class="">
                        ...
                        <th>প্রকল্প সারসংক্ষেপ বিবরণ</th>
                        <th>স্ট্যাটাস</th>
                    ...
                    @forelse ($data as $item)
                        <tr>
                            ...
                            <td class="text-truncate" style="max-width: 200px;">
                                {{ strip_tags(str_replace('&nbsp;', ' ', $item->prokolpo_sarsongkhep_description)) }}</td>
