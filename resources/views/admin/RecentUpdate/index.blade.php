...
@section('title', 'সাম্প্রতিক আপডেট তালিকা')
@section('content-header', 'সাম্প্রতিক আপডেট তালিকা')
@section('content-actions')
    <a href="{{ route('recent-updates.create') }}" class="btn btn-success">তৈরি করুন</a>
@endsection
@section('css')
                    ...
                    @forelse ($data as $item)
                        <tr class="">
                            ...
                            <td class="text-truncate" style="max-width: 200px;">
                                {{ strip_tags(str_replace('&nbsp;', ' ', $item->details)) }}</td>
                            {{-- <td>{{$item->link}}</td> --}}
                            ...
                            <td class="text-center d-flex justify-content-center align-items-center">
                                ...
                                <a href="{{ route('recent-updates.edit', $item) }}" class="btn btn-primary"><i
                                        class="fas fa-edit"></i> </a>
                                <button class="btn btn-danger btn-delete ml-1"
                                    data-url="{{ route('recent-updates.destroy', $item) }}"><i
            ...
            $(document).ready(function() {
                $(document).on('click', '.btn-delete', function() {
                    ...
                    swalWithBootstrapButtons.fire({
                        ...
                        text: "আপনি কি সত্যিই এই সাম্প্রতিক আপডেটটি মুছতে চান?",
                        icon: 'warning',
