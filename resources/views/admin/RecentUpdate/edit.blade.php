...
@section('title', 'আপডেট সম্পাদনা করুন')
@section('content-header', 'আপডেট সম্পাদনা করুন')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('recent-updates.update', $data) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <input type="text" name="link" class="form-control @error('link') is-invalid @enderror" id="link" placeholder="Link" value="{{ old('link', $data->link) }}">
                @error('link')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
                ...
                <div class="mb-5">
                    ...
                    <a href="{{ route('recent-updates.index') }}" class="btn btn-danger">বাতিল করুন</a>
