...
@section('title', 'ভিডিও-লিঙ্ক তৈরি করুন')
@section('content-header', 'ভিডিও-লিঙ্ক তৈরি করুন')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('land-related-video-links.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="link" class="form-control @error('link') is-invalid @enderror"
                        id="link" placeholder="ইউটিউব ভিডিও লিঙ্ক লিখুন" value="{{ old('link') }}">
                    @error('link')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <a href="{{ route('land-related-video-links.index') }}" class="btn btn-danger">বাতিল করুন</a>
