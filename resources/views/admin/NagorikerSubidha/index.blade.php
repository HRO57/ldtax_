...
@section('title', 'নাগরিকের সুবিধা তালিকা')
@section('content-header', 'নাগরিকের সুবিধা তালিকা')
@section('content-actions')
    <a href="{{ route('nagoriker_subidhas.create') }}" class="btn btn-success">তৈরি করুন</a>
@endsection
@section('css')
                    ...
                    @forelse ($data as $item)
                        <tr>
                            ...
                            <td class="text-truncate" style="max-width: 200px;">
                                {{ strip_tags(str_replace('&nbsp;', ' ', $item->nagoriker_subidha_description)) }}</td>
