...
@section('title', 'মিডিয়া-লিঙ্ক সম্পাদনা করুন')
@section('content-header', 'মিডিয়া-লিঙ্ক সম্পাদনা করুন')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('land-related-media-links.update', $data->id) }}" method="POST"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="link" class="form-control @error('link') is-invalid @enderror"
                        id="link" placeholder="লিঙ্ক লিখুন" value="{{ old('link', $data->link) }}">
                    @error('link')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <select name="type" class="form-control @error('type') is-invalid @enderror" id="type">
                        <option {{ old('type', $data->type) === 1 ? 'selected' : '' }} value="1">সেবা ওয়েবলিংক
                        </option>
                        <option {{ old('type', $data->type) === 2 ? 'selected' : '' }} value="2">তথ্যের অধিকার</option>
                    </select>
                    @error('type')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
